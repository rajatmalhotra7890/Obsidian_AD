# Kill Chain
- This network has multiple attack paths, some of which are stated here. However, to start from the beginning follow all of the room tasks in order.


[Overview and Background Section]

    [Task 1] Chapter One (Intro)

    [Task 2] Black Box vs. White Box (Intro)

    [Task 3] Kill Chain (Control Panel)
